...
typedef Axi4MasterBits#(DdrAddrWidth, DdrBusWidth, DdrIdWidth, Empty) Axi4DdrMaster;
...
interface Ddr3TestIndication;
  ...
  method Action readDone(Bit#(16) id,
    Bit#(32) v1, Bit#(32) v2, Bit#(32) v3, Bit#(32) v4,
    Bit#(32) v5, Bit#(32) v6,Bit#(32) v7, Bit#(32) v8,
    Bit#(32) v9, Bit#(32) v10, Bit#(32) v11, Bit#(32) v12,
    Bit#(32) v13, Bit#(32) v14, Bit#(32) v15, Bit#(32) v16
...
interface DdrAws;
  ...
  interface Axi4DdrMaster ddr3;
endinterface

module mkAxi4MasterBitsEmpty#(Axi4Master#(addrWidth, dataWidth, tagWidth) m)
  (Axi4MasterBits#(addrWidth, busDataWidth, busTagWidth, Empty))
  provisos (
    Add#(dataWidth, d__, busDataWidth), // dataWidth <= busDataWidth
    Div#(dataWidth, 32, dataWidthWords), // dataWidth / 32 = dataWidthWords
    Add#(tagWidth, t__, busTagWidth), // tagWidth <= busTagWidth
    Add#(a__, TDiv#(dataWidth, 8), TDiv#(busDataWidth, 8)) // dataWidth / 8 <= busDataWidth / 8
  );

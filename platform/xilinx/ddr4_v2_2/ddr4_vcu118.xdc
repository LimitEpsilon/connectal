...
#set portal_pcieclk [get_clocks -of_objects [get_pins *ep7/CLK_epPcieClock]]
...
#set_false_path -from [get_pins -hier -filter {NAME=~ *ddr4_ctrl_0/*ui_clk_sync_rst}]
#set_false_path -from [get_pins -hier -filter {NAME=~ *ddr4_ctrl_1/*ui_clk_sync_rst}]


#set_clock_groups -asynchronous -group $portal_pcieclk -group $ddr4_usrclk1
#set_clock_groups -asynchronous -group $portal_pcieclk -group {sys_clk1_250}
...
#set_clock_groups -asynchronous -group $portal_pcieclk -group $ddr4_usrclk2
#set_clock_groups -asynchronous -group $portal_pcieclk -group {sys_clk2_250}
